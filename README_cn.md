...
| [KERV](https://github.com/zhengzihaoPKU/KERV) | VLA 推理优化 | 基座 [OpenVLA-7B](https://huggingface.co/openvla/openvla-7b) | ✅ [验证模型](https://github.com/flagos-ai/FlagScale/blob/main/examples/kerv/README.md#train-the-verifier) / [草稿模型](https://github.com/flagos-ai/FlagScale/blob/main/examples/kerv/README.md#train-the-drafter) | ✅ [指南](https://github.com/flagos-ai/FlagScale/blob/main/examples/kerv/README.md#run-inference) | ❌ | ✅ [LIBERO](https://github.com/flagos-ai/FlagScale/blob/main/examples/kerv/README.md#run-inference) |
